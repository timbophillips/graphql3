...
@Component({
  selector: 'app-filter-select2',
  templateUrl: './filter-select2.component.html',
  styleUrls: ['./filter-select2.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FilterSelect2Component
